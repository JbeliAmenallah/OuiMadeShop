...
const Clock = () => {
    ...
    const countDown = () => {
        ...
        interval = setInterval(() => {
            ...
            // Calculate the time difference between now and the destination time
            ...
            if (destination < 0) clearInterval(interval.current) // Stop the countdown if the destination time has passed
            else {
